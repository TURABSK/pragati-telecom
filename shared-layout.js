...
(function () {
  ...
  function getHeaderHTML() {
    ...
    const isFormFiller = currentPath.includes('exact-form-filler.html');
    ...
    <div class="nav-container">
      ...
      <ul class="nav-links">
        ...
        <li>
          <a href="${basePath}tools/exact-form-filler.html" class="nav-link ${isFormFiller ? 'active' : ''}">
            <span>✍️</span> Form Filler
          </a>
        </li>
        <li>
    ...
    <div class="mobile-drawer" id="mobileDrawer">
      ...
      <ul class="drawer-links">
        ...
        <li><a href="${basePath}tools/exact-form-filler.html" class="nav-link ${isFormFiller ? 'active' : ''}"><span>✍️</span> Exact Form Filler Pro</a></li>
        ...
        <li><a href="${basePath}index.html" class="nav-link"><span>🛠️</span> Browse All Tools</a></li>
      </ul>
  ...
  function getFooterHTML() {
    ...
    <div class="footer-container">
      <div class="footer-grid">
        ...
        <!-- Col 3: Premium PDF & Form Suite -->
        <div class="footer-col">
          <div class="footer-col-title">PDF &amp; Forms Suite</div>
          <ul class="footer-links-list">
            <li><a href="${basePath}tools/exact-form-filler.html" class="footer-link">✍️ Exact Form Filler Pro</a></li>
